...
> Codex ведёт саму сессию по [`RITUALS.md`](RITUALS.md) — восемь ритуалов: что назвать человеку в начале и чем закончить день, как продолжить с прошлого раза, что делать самому и где ждать «да», как договориться до дела, как разбирать поломку, как отчитаться понятно, как отложить с точкой возврата и как завершить встречу.
...
| 99 | `99-appendix-backend/` | Python/venv, Railway | **по требованию** (Фаза 2 курса, в LMS), НЕ сейчас | — |
...
(урок 1.1 «Режим плана (Plan Mode): сначала план, потом дело»; проходится в `~/vibecoding/vibecoding_first_app`, если был
